...
newtype BackfaceVisiblity = BackfaceVisiblity String

instance visibleBackface :: VisibilityEnum BackfaceVisiblity where
  hidden = BackfaceVisiblity "hidden"
  visible = BackfaceVisiblity "visible"

backfaceVisibility :: BackfaceVisiblity -> StyleProp
